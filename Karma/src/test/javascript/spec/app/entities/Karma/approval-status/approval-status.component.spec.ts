...
import { ApprovalStatusComponent } from 'app/entities/Karma/approval-status/approval-status.component';
...
describe('Component Tests', () => {
  describe('ApprovalStatus Management Component', () => {
    let comp: ApprovalStatusComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ApprovalStatusComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.approvalStatuses[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
