...
import { UserCheckComponent } from 'app/entities/Karma/user-check/user-check.component';
...
describe('Component Tests', () => {
  describe('UserCheck Management Component', () => {
    let comp: UserCheckComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(UserCheckComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.userChecks[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
