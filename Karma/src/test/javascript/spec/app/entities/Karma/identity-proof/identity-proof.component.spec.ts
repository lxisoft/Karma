...
import { IdentityProofComponent } from 'app/entities/Karma/identity-proof/identity-proof.component';
...
describe('Component Tests', () => {
  describe('IdentityProof Management Component', () => {
    let comp: IdentityProofComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(IdentityProofComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.identityProofs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
