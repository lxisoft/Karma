...
import { AddressService } from 'app/entities/Karma/address/address.service';
import { IAddress, Address } from 'app/shared/model/Karma/address.model';
...
describe('Service Tests', () => {
  describe('Address Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Address(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 0);
    });
