...
public class AggregateServiceImpl implements AggregateService {
	...
	public Page<HelpDTO> findAllHelps(Pageable pageable) {
		...
		Page<HelpDTO> helpDTO = helpRepository.findAll(pageable).map(helpMapper::toDto);
	...
	public Long calculateRegisteredUserEmotionalQuotient(Long registeredUserId) {
		...
		RegisteredUserDTO registeredUserDTO = registeredUserRepository.findById(registeredUserId)
				.map(registeredUserMapper::toDto).orElse(null);
	...
	public Page<MediaDTO> findAllUrlByNeedId(Long needId, Pageable pageable) {
		// TODO Auto-generated method stub
		return mediaRepository.findAllUrlByNeedId(needId, pageable).map(mediaMapper::toDto);
	}
