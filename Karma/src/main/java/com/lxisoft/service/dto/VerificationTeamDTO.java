...
public class VerificationTeamDTO implements Serializable {
    ...
    private Set<RegisteredUserDTO> approvingUsers = new HashSet<>();
    ...
    public Set<RegisteredUserDTO> getApprovingUsers() {
        return approvingUsers;
    }

    public void setApprovingUsers(Set<RegisteredUserDTO> registeredUsers) {
