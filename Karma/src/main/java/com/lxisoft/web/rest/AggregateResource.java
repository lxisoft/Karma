...
public class AggregateResource {
	 ...
	 *         new needDTO, or with status 400 (Bad Request) if the need has
	 *         already an ID
	...
	public ResponseEntity<NeedDTO> PostNeed(@RequestBody NeedDTO needDTO) throws URISyntaxException, IOException {
		...
		return ResponseEntity.created(new URI("/api/needs/" + needDto.getId()))
				.headers(HeaderUtil.createEntityCreationAlert("Need", needDto.getId().toString())).body(needDto);
	}
	 ...
	 * @return the ResponseEntity with status 200 (OK) and the list of needs in
	 *         body
	 */
	@GetMapping("/needs")
	@Timed
	public ResponseEntity<List<NeedDTO>> getAllNeeds(Pageable pageable,
		...
		// Page<NeedDTO> page1 = new PageImpl<NeedDTO>(needs, pageable,
		// needs.size());

		HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page,
				String.format("/api/needs?eagerload=%b", eagerload));
	 ...
	 *         needDTO, or with status 404 (Not Found)
	 */
	@GetMapping("/needs/{id}")
	@Timed
	 ...
	 *
	 * @param id
	 *            the id of the needDTO to delete
	...
	@Timed
	public ResponseEntity<List<NeedDTO>> getAllNeedsBySeverityId(Pageable pageable, @PathVariable Long severityId,
			@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
		...
		HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page,
				String.format("/api/severitylevel/?eagerload=%b", eagerload));
		return new ResponseEntity<>(page.getContent(), headers, HttpStatus.OK);
	 ...
	 *
	 * @param id
	 *            the id of the approvalStatusDTO to retrieve
	 * @return the ResponseEntity with status 200 (OK) and with body the
	 *         approvalStatusDTO, or with status 404 (Not Found)
	 */
	 ...
	 * @return the ResponseEntity with status 201 (Created) and with body the
	 *         new helpDTO, or with status 400 (Bad Request) if the help has
	 *         already an ID
	 * @throws URISyntaxException
	 *             if the Location URI syntax is incorrect
	 * @throws IOException
	...
	public ResponseEntity<HelpDTO> helpNeedy(@RequestBody HelpDTO helpDTO) throws URISyntaxException, IOException {
		...
		return ResponseEntity.created(new URI("/api/helps/createHelpWithMedia" + helpDto.getId()))
				.headers(HeaderUtil.createEntityCreationAlert("Help", helpDto.getId().toString())).body(helpDto);
	}
	 ...
	 *
	 * @param helpDTO
	 *            the helpDTO to update
	 * @return the ResponseEntity with status 200 (OK) and with body the updated
	 *         helpDTO, or with status 400 (Bad Request) if the helpDTO is not
	 *         valid, or with status 500 (Internal Server Error) if the helpDTO
	 *         couldn't be updated
	 * @throws URISyntaxException
	 *             if the Location URI syntax is incorrect
	 * @throws IOException
	...
	public ResponseEntity<HelpDTO> updateHelp(@RequestBody HelpDTO helpDTO) throws URISyntaxException, IOException {
		...
		return ResponseEntity.ok().headers(HeaderUtil.createEntityUpdateAlert("Help", helpDTO.getId().toString()))
				.body(result);
	}
	 ...
	 * @param pageable
	 *            the pagination information
	 * @return the ResponseEntity with status 200 (OK) and the list of helps in
	 *         body
	 */
	@GetMapping("/helps")
	@Timed
	 ...
	 * @return the ResponseEntity with status 200 (OK) and with body the
	 *         helpDTO, or with status 404 (Not Found)
	 */
	@GetMapping("/helps/{id}")
	@Timed
	 ...
	 *
	 * @param id
	 *            the id of the helpDTO to delete
	 * @return the ResponseEntity with status 200 (OK)
	 */
	...
	@Timed
	public ResponseEntity<List<HelpDTO>> getAllHelpsByApprovedStatus(Pageable pageable,
	...
	@Timed
	public ResponseEntity<List<HelpDTO>> getAllHelpsByfulfilledNeedId(Pageable pageable,
			@PathVariable Long fulfilledNeedId) {
		log.debug("REST request to get a page of Helps");
	...
	@Timed
	public ResponseEntity<UserCheckDTO> createUserCheck(@RequestBody UserCheckDTO userCheckDTO)
			throws URISyntaxException {
		...
		return ResponseEntity.created(new URI("/api/user-checks/" + result.getId()))
				.headers(HeaderUtil.createEntityCreationAlert("UserCheck", result.getId().toString())).body(result);
	}
	 ...
	 *
	 * @param userCheckDTO
	 *            the userCheckDTO to update
	 * @return the ResponseEntity with status 200 (OK) and with body the updated
	 *         userCheckDTO, or with status 400 (Bad Request) if the
	 *         userCheckDTO is not valid, or with status 500 (Internal Server
	 *         Error) if the userCheckDTO couldn't be updated
	 * @throws URISyntaxException
	 *             if the Location URI syntax is incorrect
	 */
	@PutMapping("/user-checks")
	@Timed
	public ResponseEntity<UserCheckDTO> updateUserCheck(@RequestBody UserCheckDTO userCheckDTO)
			throws URISyntaxException {
		...
		return ResponseEntity.ok()
				.headers(HeaderUtil.createEntityUpdateAlert("UserCheck", userCheckDTO.getId().toString())).body(result);
	}
	...
	@Timed
	public ResponseEntity<List<UserCheckDTO>> getAllUserChecksByCheckedNeedId(Pageable pageable,
			@PathVariable Long checkedNeedId) {
	 ...
	 * @return the ResponseEntity with status 201 (Created) and with body the
	 *         new replyDTO, or with status 400 (Bad Request) if the reply has
	 *         already an ID
	 * @throws URISyntaxException
	 *             if the Location URI syntax is incorrect
	 */
	...
	public ResponseEntity<ReplyDTO> addReply(@RequestBody ReplyDTO replyDTO) throws URISyntaxException {
		...
		return ResponseEntity.created(new URI("/api/replies/" + result.getId()))
				.headers(HeaderUtil.createEntityCreationAlert("Reply", result.getId().toString())).body(result);
	}
	 ...
	 * @param pageable
	 *            the pagination information
	 * @return the ResponseEntity with status 200 (OK) and the list of replies
	 *         in body
	 */
