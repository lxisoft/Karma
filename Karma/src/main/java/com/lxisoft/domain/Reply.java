...
public class Reply implements Serializable {
    ...
    private RegisteredUser repliedUser;
    ...
    public RegisteredUser getRepliedUser() {
        return repliedUser;
    }

    public Reply repliedUser(RegisteredUser registeredUser) {
        this.repliedUser = registeredUser;
        return this;
    }

    public void setRepliedUser(RegisteredUser registeredUser) {
        this.repliedUser = registeredUser;
    }
