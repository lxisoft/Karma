...
public class RegisteredUser implements Serializable {
	...
	@ManyToMany
	@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
	@JoinTable(name = "registered_user_followers", joinColumns = @JoinColumn(name = "registered_users_id", referencedColumnName = "id"), inverseJoinColumns = @JoinColumn(name = "followers_id", referencedColumnName = "id"))
	...
	public String toString() {
		return "RegisteredUser{" + "id=" + getId() + ", email='" + getEmail() + "'" + ", firstName='" + getFirstName()
				+ "'" + ", lastName='" + getLastName() + "'" + ", rating=" + getRating() + ", description='"
				+ getDescription() + "'" + ", profession='" + getProfession() + "'" + ", gender='" + getGender() + "'"
				+ ", dob='" + getDob() + "'" + ", bloodGroup='" + getBloodGroup() + "'" + ", emotionalQuotient="
				+ getEmotionalQuotient() + ", socialQuotient=" + getSocialQuotient() + ", happinessIndex="
				+ getHappinessIndex() + "}";
	}
}
