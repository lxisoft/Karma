...
public class Need implements Serializable {
    ...
    @ManyToOne
    @JsonIgnoreProperties("needs")
    private RegisteredUser postedUser;
    ...
    public RegisteredUser getPostedUser() {
        return postedUser;
    }

    public Need postedUser(RegisteredUser registeredUser) {
        this.postedUser = registeredUser;
        return this;
    }

    public void setPostedUser(RegisteredUser registeredUser) {
        this.postedUser = registeredUser;
    }
