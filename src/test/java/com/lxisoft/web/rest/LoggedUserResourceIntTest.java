...
public class LoggedUserResourceIntTest {
    ...
    public void setup() {
        ...
        final LoggedUserResource loggedUserResource = new LoggedUserResource(loggedUserService);
    ...
    public void dtoEqualsVerifier() throws Exception {
        TestUtil.equalsVerifier(LoggedUserDTO.class);
        LoggedUserDTO loggedUserDTO1 = new LoggedUserDTO();
        loggedUserDTO1.setId(1L);
        LoggedUserDTO loggedUserDTO2 = new LoggedUserDTO();
        assertThat(loggedUserDTO1).isNotEqualTo(loggedUserDTO2);
        loggedUserDTO2.setId(loggedUserDTO1.getId());
        assertThat(loggedUserDTO1).isEqualTo(loggedUserDTO2);
        loggedUserDTO2.setId(2L);
        assertThat(loggedUserDTO1).isNotEqualTo(loggedUserDTO2);
        loggedUserDTO1.setId(null);
        assertThat(loggedUserDTO1).isNotEqualTo(loggedUserDTO2);
    }
    ...
    public void testEntityFromId() {
        assertThat(loggedUserMapper.fromId(42L).getId()).isEqualTo(42);
        assertThat(loggedUserMapper.fromId(null)).isNull();
    }
}
