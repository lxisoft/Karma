...
public class LoggedUser implements Serializable {
    ...
    @ManyToMany(mappedBy = "willingUsers")
    @JsonIgnore
    private Set<Need> needs = new HashSet<>();
    ...
    public LoggedUser services(Set<Service> services) {
        this.services = services;
        return this;
    }

    public LoggedUser addServices(Service service) {
        this.services.add(service);
        service.setLoggedUser(this);
        return this;
    }

    public LoggedUser removeServices(Service service) {
    ...
    public LoggedUser addNeeds(Need need) {
        this.needs.add(need);
        need.getWillingUsers().add(this);
        return this;
    }

    public LoggedUser removeNeeds(Need need) {
        this.needs.remove(need);
        need.getWillingUsers().remove(this);
        return this;
    }
