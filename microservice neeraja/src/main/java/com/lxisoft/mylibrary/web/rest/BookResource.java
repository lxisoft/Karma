...
import com.lxisoft.mylibrary.repository.BookRepository;
...
public class BookResource {
    ...
    private static final String ENTITY_NAME = "mylibraryBook";
     ...
     * GET  /books/:id : GET the "id" book.
     *
     * @param id the id of the author to get his book
     * @return the list of the books of the author status 200 (OK)
     */
    ...
    /**
     * GET  /categories/books/:id : GET the "id" categories.
     *
     * @param id the id of the categories to get books of the category
     * @return the list of the books of the category status 200 (OK)
     */
    @GetMapping("/getCategoryBooks/{id}")
    @Timed
    
    public List<Book> getCategoryBooks(@PathVariable Long id){
    	log.debug("REST request to get Books of a category : {}",id); 
