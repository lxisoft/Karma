 ...
 * org.springframework.cloud.openfeign.FeignClientsConfiguration; import
 ...
 * @Documented
 * 
 * @FeignClient public @interface AuthorizedFeignClient {
 * 
 * @AliasFor(annotation = FeignClient.class, attribute = "name") String name()
 * default "";
 * 
 *//**
