...
public class HelpDTO {
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.approvalStatusId, helpDTO.approvalStatusId)
				...
				&& Objects.equals(this.fulfilledNeedId, helpDTO.fulfilledNeedId) && Objects.equals(this.id, helpDTO.id)
				...
				&& Objects.equals(this.time, helpDTO.time) && Objects.equals(this.timeElapsed, helpDTO.timeElapsed)
	...
	@Override
	public int hashCode() {
		return Objects.hash(approvalStatusId, attachmentUrls, description, fulfilledNeedId, id, noOfComments,
				noOfDisLikes, noOfLikes, providedUserId, time, timeElapsed, timeInString, userName);
	}
