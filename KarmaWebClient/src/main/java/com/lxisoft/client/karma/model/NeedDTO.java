...
public class NeedDTO {
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.approvalStatusId, needDTO.approvalStatusId)
				...
				&& Objects.equals(this.categoryList, needDTO.categoryList) && Objects.equals(this.date, needDTO.date)
				&& Objects.equals(this.dateInString, needDTO.dateInString)
				&& Objects.equals(this.description, needDTO.description) && Objects.equals(this.id, needDTO.id)
	...
	@Override
	public int hashCode() {
		return Objects.hash(approvalStatusId, attachmentUrls, beneficiaryType, categories, categoryList, date,
				dateInString, description, id, noOfComments, noOfHelps, noOfRecommendations, percentageOfGenuineness,
				personInChargeId, postedUserId, severityId, severityLevel, timeElapsed, userName, verificationTeamId);
	}
